...
import time
import joblib
print("FUSION ENGINE FILE :", __file__)
...
def predict_fusion(frame):
    ...
    visual_conf = visual_prob[visual_idx] * 100
    ...
    fusion_conf = fusion_prob[fusion_idx] * 100
    ...
    cv2.putText(
        frame,
        f"{fusion_emotion} ({fusion_conf:.1f}%)",
        (x,y-10),
